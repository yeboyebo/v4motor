<div class="row content-categorias">
		<div class="col-md-4 col-xs-12 item">
			<h3>Búsqueda por categorías</h3>
			<ul class="category-links">
				<li>
					<a href="<?= get_category_link(15) ?>">Ocio y familiares</a>
				</li>
				<li>
		...
		<div class="col-md-4 col-xs-6 item">
			<a href="<?= get_category_link(15) ?>"  data-type="Y1">
				<span class="category_name"><?php echo ('Ocio y familiares');?></span>
		...
		<div class="col-md-4 col-xs-6 item">
			<a href="<?= get_category_link(14) ?>"  data-type="Y7">
				...
				<img src="<?php echo TEMPLATEURI;?>/images/vehiculos/Isotermo.png"/>
			</a>
		</div>
		...
		<div class="col-md-4 col-xs-6 item">
			<a href="<?= get_category_link(18) ?>" data-type="Y8">
				<span class="category_name"><?php echo ('Turismo');?></span>
				<img src="<?php echo TEMPLATEURI;?>/images/vehiculos/Turismos.png"/>
			</a>
		</div>
</div>
</div>